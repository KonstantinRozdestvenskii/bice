...
$(document).ready(() => {
    ...
    catalogSlider.slick({
        ...
        slidesToScroll: 3,
        arrows: true,
        prevArrow: '<button type="button" class="slick-prev custom-arrow" aria-label="Previous"><img src="src/images/icons/prev.png"></button>',
        nextArrow: '<button type="button" class="slick-next custom-arrow" aria-label="Next"><img src="src/images/icons/next.png"></button>',
        dots: true,
    ...
    feedbackSlider.slick({
        ...
        slidesToScroll: 3,
        arrows: true,
        prevArrow: '<button type="button" class="slick-prev custom-arrow" aria-label="Previous"><img src="src/images/icons/prev2.png"></button>',
        nextArrow: '<button type="button" class="slick-next custom-arrow" aria-label="Next"><img src="src/images/icons/next2.png"></button>',
        dots: true,
